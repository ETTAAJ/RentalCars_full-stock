  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
      ...
      <div class="col-span-1 md:col-span-2">
        <h2 class="text-2xl font-bold text-gold mb-3">GoldCar</h2>
        <p class="text-gray-400 text-sm leading-relaxed max-w-md">
          Premium car rental with golden service. Drive your dream car today.
        </p>

        <!-- Social Media Icons -->
        <div class="flex space-x-4 mt-5">
          <!-- Instagram -->
          <a href="https://instagram.com/goldcar_rental" target="_blank" 
          ...
          <!-- Facebook -->
          <a href="https://facebook.com/goldcar.rental" target="_blank" 
             class="text-gray-400 hover:text-gold transition transform hover:scale-110">
          ...
          <!-- X (Twitter) -->
          <a href="https://twitter.com/goldcar_rental" target="_blank" 
             class="text-gray-400 hover:text-gold transition transform hover:scale-110">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="X (Twitter)">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-gray-400">
          ...
          <li class="flex items-center">
            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884zM18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/></svg>
            contact@goldcar.ma
          </li>
          <li class="flex items-center">
    ...
    <div class="border-t border-gray-800 pt-6 text-center text-xs text-gray-500">
      <p>© 2025 GoldCar Rental. All rights reserved. | 
